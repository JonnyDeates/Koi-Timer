...
import secondsHourGlass from "../../CustomTimer/assets/timer-icon-seconds.png";
import minutesHourGlass from "../../CustomTimer/assets/timer-icon-minutes.png";
import hoursHourGlass from "../../CustomTimer/assets/timer-icon-hours.png";
