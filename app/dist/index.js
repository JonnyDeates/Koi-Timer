...
var require_cookie_parser = __commonJS({
  "node_modules/cookie-parser/index.js"(exports, module2) {
    "use strict";
...
// src/configuration/morgan.ts
var import_morgan = __toESM(require_morgan());
var morganOption = config_default.NODE_ENV === "production" ? "tiny" : "common";
var morganConfig = () => (0, import_morgan.default)(morganOption);
var morgan_default = morganConfig;

// src/configuration/cors.ts
var import_cors = __toESM(require("cors"));
var allowedOrigins = config_default.NODE_ENV === "development" ? ["http://localhost:5000"] : ["http://koitimer.com", "https://koitimer.com", "http://www.koitimer.com", "https://www.koitimer.com"];
...
var helmet_default = helmetConfig;

// src/index.ts
var import_path = __toESM(require("path"));
var sendIndexHtml = (req, res, status = 200) => {
  const directoryToBuild = import_path.default.join(__dirname.substring(0, __dirname.length - 4), "build", "index.html");
...
var createServer = async () => {
  ...
  app.use(morgan_default());
  app.use(cors_default());
  app.use(helmet_default());
  app.use((0, import_cookie_parser.default)());
  const publicRoutes = import_express.default.static("build");
  app.use("/", async function(req, res, next) {
    publicRoutes(req, res, next);
  });
  app.get("/", (req, res) => sendIndexHtml(req, res));
  app.get("*", (req, res) => sendIndexHtml(req, res, 404));
  app.listen(config_default.PORT, () => console.log(`Listening on http://localhost:${config_default.PORT}`));
};
createServer();
