...
const Header = () => {
    ...
    return (
        <div className="header">
            <h1>K<img src={logo} alt={'o'} onAnimationEnd={() => setIsRotating(true)}
            ...
            <CustomTimes setCustomTimes={setCustomTimes} active={customTimes} />
            <Sounds setSounds={this.setSounds} active={this.state.sounds} volume={.context.volume} />
        </div>
    );
